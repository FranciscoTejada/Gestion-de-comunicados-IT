...
# Parte de fran
class Ticket:
    def __init__(self, titulo, descripcion, creador, timezone=pytz.timezone('America/Argentina/Buenos_Aires')):
        self.titulo = titulo
        self.descripcion = descripcion
        self.estado = "Pendiente"
        self.fecha_creacion = datetime.now(timezone).strftime('%Y-%m-%d %H:%M:%S')
        self.comentarios = []
